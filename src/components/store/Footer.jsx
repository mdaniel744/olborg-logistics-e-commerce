        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 lg:gap-16">
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm">
              <li>
                <Link href={pathFor("shop", lang)} className="text-white/80 hover:text-[#F5A623]">{t("nav.allContainers")}</Link>
              </li>
              {shopLinks.map((c) => (
                <li key={c.key}>
                  <Link href={c[lang]} className="text-white/80 hover:text-[#F5A623]">{landingLabel(c)}</Link>
                </li>
              ))}
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm">
              {infoLinks.map((l) => (
                <li key={l.key}>
                  <Link href={pathFor(l.key, lang)} className="text-white/80 hover:text-[#F5A623]">{l.label}</Link>
                </li>
              ))}
            </ul>
          </div>
